...
document.getElementById("save").onclick = function () {
  container = document.getElementById("save").data;

  for (const challenge in container.lsChallenges) {
    console.log(container.lsChallenges[challenge]);
    writereadChallengesData(
      challenge,
      container.lsChallenges[challenge]["description"],
      container.lsChallenges[challenge].points,
      container.lsChallenges[challenge].completed
    );
  }
};
